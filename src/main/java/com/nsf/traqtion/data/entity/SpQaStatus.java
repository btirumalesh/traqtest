...
/**
 * The persistent class for the sp_qa_status database table.
 * 
 */
@Entity
@Table(name="sp_qa_status")
@NamedQuery(name="SpQaStatus.findAll", query="SELECT s FROM SpQaStatus s")
public class SpQaStatus implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	@Column(name="sp_qa_status_id")
	private String spQaStatusId;
	...
	public String getSpQaStatusId() {
		return this.spQaStatusId;
	}

	public void setSpQaStatusId(String spQaStatusId) {
		this.spQaStatusId = spQaStatusId;
	}
