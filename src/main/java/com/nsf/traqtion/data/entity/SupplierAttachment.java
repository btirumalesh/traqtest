...
@NamedQuery(name="SupplierAttachment.findAll", query="SELECT s FROM SupplierAttachment s")
public class SupplierAttachment implements Serializable {
	...
	private String supplierAttachmentId;
	...
	public String getSupplierAttachmentId() {
		return this.supplierAttachmentId;
	}

	public void setSupplierAttachmentId(String supplierAttachmentId) {
