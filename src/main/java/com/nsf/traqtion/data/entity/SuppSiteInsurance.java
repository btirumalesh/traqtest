...
/**
 * The persistent class for the supp_site_insurance database table.
 * 
 */
@Entity
@Table(name="supp_site_insurance")
@NamedQuery(name="SuppSiteInsurance.findAll", query="SELECT s FROM SuppSiteInsurance s")
public class SuppSiteInsurance implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy=GenerationType.IDENTITY)
	@Column(name="supp_site_insurance_id")
	private String suppSiteInsuranceId;
	...
	public SuppSiteInsurance() {
	}

	public String getSuppSiteInsuranceId() {
		return this.suppSiteInsuranceId;
	}

	public void setSuppSiteInsuranceId(String suppSiteInsuranceId) {
		this.suppSiteInsuranceId = suppSiteInsuranceId;
	}
